...
register(
    id='HalfInvertedPendulum-v0',
    entry_point='gym.envs.mujoco:HalfInvertedPendulumEnv',
    max_episode_steps=1000,
    reward_threshold=950.0,
)

register(
    id='HighGravityInvertedPendulum-v0',
    entry_point='gym.envs.mujoco:HighGravityInvertedPendulumEnv',
    max_episode_steps=1000,
    reward_threshold=950.0,
)

register(
    id='LowGravityInvertedPendulum-v0',
    entry_point='gym.envs.mujoco:LowGravityInvertedPendulumEnv',
    max_episode_steps=1000,
    reward_threshold=950.0,
)

register(
    id='LowFrictionInvertedPendulum-v0',
    entry_point='gym.envs.mujoco:LowFrictionInvertedPendulumEnv',
    max_episode_steps=1000,
    reward_threshold=950.0,
)

register(
    id='HighFrictionInvertedPendulum-v0',
    entry_point='gym.envs.mujoco:LowFrictionInvertedPendulumEnv',
    max_episode_steps=1000,
    reward_threshold=950.0,
)
